...
import com.observeai.platform.realtime.neutrino.service.events.CallResumeEventsJoiner;
...
public class CallResumeMetaEventHandler implements CallBackMetaEventHandler {
    private final CallBackMetaEventsRedisStore redisStore;
    private final CallResumeEventsJoiner eventsJoiner;
